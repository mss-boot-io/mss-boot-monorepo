module github.com/mss-boot-io/mss-boot-monorepo/mss-boot/store

go 1.18

replace github.com/robinjoseph08/redisqueue/v2 v2.1.0 => github.com/mss-boot-io/redisqueue/v2 v2.1.1-0.20220322163450-bd95f801612c
