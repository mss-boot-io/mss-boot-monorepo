...
func (e *NSQ) GetCache() (storage.AdapterCache, error) {
	return nil, errors.New("method GetCache not implemented")
}

func (e *NSQ) GetQueue() (storage.AdapterQueue, error) {
	cfg, err := e.GetNSQOptions()
	if err != nil {
		return nil, err
	}
	return queue.NewNSQ(e.Addresses, cfg, e.ChannelPrefix)
}
...
func (e NSQOptions) GetNSQOptions() (*nsq.Config, error) {
	cfg := nsq.NewConfig()
	var err error
	cfg.TlsConfig, err = e.Tls.GetTLS()
	if err != nil {
		return nil, err
	}
	if e.DialTimeout > 0 {
